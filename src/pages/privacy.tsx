  ...
  return (
    ...
    >
      <article className='prose !prose-invert prose-neutral px-4 pt-32'>
        ...
        <p>
          Frosty is an unofficial open-source mobile Twitch client/app for iOS
          and Android. We are dedicated to protecting your privacy. Frosty does
          not collect or share any personal information. However, we may gather
          anonymous usage data and crash logs solely to improve the app. For
          more information, please refer to the sections below.
        </p>
        ...
        <p>
          ...
          to chat, and provide additional features. You can optionally log in
          with your Twitch account to access user-specific features, such as
          sending chat messages and viewing your followed channels.
        </p>
        <p>
          If you log in using Twitch, Frosty will only ask you for the necessary
          and required permissions to function. Frosty will then obtain your
          OAuth access token and send requests to receive and transmit data to
          Twitch only on your behalf. This access token is stored and encrypted
        ...
        <p>
          ...
          channel, Frosty will request these services using your public Twitch
          ID or username to obtain emotes and badges associated with your
          channel.
        </p>
        <p>
          For more information on how 7TV, BTTV, and FFZ handle your data,
        ...
        <p>
          ...
          aid in the development of new features, improvements, and bug fixes.
          The collected data is anonymous and does not contain any personal
